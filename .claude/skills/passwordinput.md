...
A password input field with a visibility toggle and an optional password strength meter.

## Import

```ts
import { PasswordInput } from 'glassui';
```
...
|------|------|---------|-------------|
| value | `string` | — | The bound password string. |
| showStrength | `boolean` | `false` | Whether to show the strength meter. |

...
export const meta: ComponentMeta = {
  name: 'Alert',
  category: 'alert',
  description: 'Color-based alert with icon, title, body, and optional dismiss. Glass and glow support.',
  since: '0.2.0',
  props: [
    { name: 'color', type: "ThemeColor", default: 'info', description: 'Alert color', options: ['info', 'success', 'warning', 'error', 'primary', 'secondary', 'accent', 'destructive', 'neutral'] },
  ...
  examples: [
    { title: 'Info', code: '<Alert color="info" title="Note">Something to know.</Alert>' },
    { title: 'Success', code: '<Alert color="success" title="Saved">Changes saved.</Alert>' },
    { title: 'Warning', code: '<Alert color="warning" title="Careful">This is destructive.</Alert>' },
    { title: 'Error', code: '<Alert color="error" title="Failed">Something went wrong.</Alert>' },
    { title: 'Glass', code: '<Alert color="info" glass title="Glass Alert">Frosted.</Alert>' },
    { title: 'Dismissible', code: '<Alert color="success" dismissible title="Done">Click X to close.</Alert>' },
  ],

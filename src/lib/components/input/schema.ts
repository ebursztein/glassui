...
export const meta: ComponentMeta = {
  name: 'Input',
  category: 'input',
  description: 'Text input with size variants, color states, label, helper text, error messages, and optional glass surface with glow on focus.',
  since: '0.2.0',
  props: [
  ...
  examples: [
    ...
    { title: 'Error color', code: '<Input label="Email" color="error" placeholder="Invalid" />' },
  ],
